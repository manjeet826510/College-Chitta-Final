        ...
        <Row className='main-box'>
          ...
          <Col md={12} lg={6}>
            ...
            <div className="secondHalf">
              ...
              <iframe className='hometop-logo' width="560" height="315" src="https://www.youtube.com/embed/MbX63of83B0?si=_77gqgNNGlEPXUbE?rel=0" title="YouTube video player" frameborder="0" allow="" referrerpolicy="" allowfullscreen></iframe>
            </div>
          </Col>
          </Row>
